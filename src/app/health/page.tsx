  ...
  return (
    <main style={{
      ...
      <div style={{ position: "relative", zIndex: 1, textAlign: "center", maxWidth: 640, padding: "0 24px" }}>
        <p style={{ fontSize: 11, letterSpacing: 6, textTransform: "uppercase", color: "#D97706", marginBottom: 24, fontWeight: 700, fontFamily: "'DM Mono', monospace" }}>
          DalxicHealth
        </p>
        ...
        <h1 style={{ fontSize: "clamp(36px, 6vw, 56px)", fontWeight: 800, lineHeight: 1.1, color: "#ECF5F0", marginBottom: 20, fontFamily: "'Space Grotesk', sans-serif", letterSpacing: "-0.02em" }}>
          Clinical care,{" "}
          <span style={{ background: "linear-gradient(135deg, #D97706, #E69A2E)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
            elevated
          </span>
        </h1>

        <p style={{ fontSize: 16, color: "rgba(236,245,240,0.45)", lineHeight: 1.7, marginBottom: 48 }}>
          Front desk, doctor station, lab, pharmacy, wards, billing.
          One platform for every hospital and clinic.
        </p>

        <Link href="/kiosk/KORLE-BU" style={{
          display: "inline-flex", alignItems: "center", gap: 10,
          padding: "14px 32px", borderRadius: 12,
          background: "linear-gradient(135deg, #D97706, #B45309)",
          color: "#fff", fontSize: 13, fontWeight: 700,
          letterSpacing: "0.08em", textTransform: "uppercase",
          textDecoration: "none", boxShadow: "0 8px 32px rgba(217,119,6,0.25)",
