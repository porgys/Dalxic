"use client"
/* ═══════════════════════════════════════════════════════════════
   DALXIC OPS — DESIGN PRIMITIVES
   Glass cards, stats, tables, buttons, modals, drawers, pills.
   Uses tokens from src/lib/tokens.ts and Icon from ./Icon.
   ═══════════════════════════════════════════════════════════════ */
...
const inputBase: CSSProperties = {
  ...
  color: T.tx, outline: "none", fontFamily: "'DM Sans', sans-serif",
}
...
export function DataTable<T extends { id?: string }>({ rows, columns, empty = "Nothing here yet.", onRowClick }: {
  rows: T[]
  columns: Column<T>[]
  empty?: string
...
/* ───── Tab strip (horizontal in-page) ───── */

export function Tabs<T extends string>({ tabs, value, onChange, accent = "emerald" }: {
