...
/* ───── Org Type → Tone mapping ───── */

export const ORG_TONE: Record<OrgType, "amber" | "copper" | "sky" | "emerald" | "neutral"> = {
  trade: "amber", health: "copper", institute: "sky", restaurant: "amber",
  salon: "emerald", gym: "emerald", mechanic: "amber", pharmacy: "emerald",
  law: "neutral", hotel: "sky",
}
...
export const HEALTH_MODULES: HealthModuleDef[] = [
  { slug: "front-desk",     group: "Clinical",    status: "live",    title: "Front Desk",       blurb: "Patient registration, queue management, emergency admission",    href: "/health/front-desk" },
  { slug: "doctor",          group: "Clinical",    status: "live",    title: "Doctor",            blurb: "Consultation, diagnosis, SOAP notes, prescriptions, referrals", href: "/health/doctor" },
  { slug: "nurse-station",   group: "Clinical",    status: "live",    title: "Nurse Station",     blurb: "Vitals recording, task management, abnormal flagging",           href: "/health/nurse-station" },
  { slug: "waiting-room",    group: "Clinical",    status: "live",    title: "Waiting Room",      blurb: "Real-time queue display, now serving, emergency alerts",         href: "/health/waiting-room" },
  { slug: "lab",             group: "Diagnostics", status: "live",    title: "Laboratory",        blurb: "Test orders, result entry, abnormal flagging",                   href: "/health/lab" },
  { slug: "pharmacy",        group: "Diagnostics", status: "live",    title: "Pharmacy",          blurb: "Prescription queue, dispensing, stock tracking",                 href: "/health/pharmacy" },
  { slug: "radiology",       group: "Diagnostics", status: "preview", title: "CT / Radiology",    blurb: "Scan queue, report writing",                                    href: "/health/radiology" },
  { slug: "ultrasound",      group: "Diagnostics", status: "preview", title: "Ultrasound",        blurb: "Sonography queue, findings",                                    href: "/health/ultrasound" },
  { slug: "ward",            group: "Inpatient",   status: "preview", title: "Ward / IPD",        blurb: "Admissions, daily rounds, discharge summaries",                  href: "/health/ward" },
  { slug: "icu",             group: "Inpatient",   status: "preview", title: "ICU",               blurb: "Vital signs grid, ventilator tracking",                          href: "/health/icu" },
  { slug: "maternity",       group: "Inpatient",   status: "preview", title: "Maternity",         blurb: "Antenatal, labour, delivery, postnatal",                         href: "/health/maternity" },
  { slug: "blood-bank",      group: "Inpatient",   status: "preview", title: "Blood Bank",        blurb: "Inventory grid, cross-match, transfusion",                       href: "/health/blood-bank" },
  { slug: "injection-room",  group: "Specialist",  status: "live",    title: "Injection Room",    blurb: "Injection orders, administration",                               href: "/health/injection-room" },
  { slug: "billing",         group: "Admin",       status: "live",    title: "Billing",           blurb: "Revenue dashboard, patient billing, payments",                   href: "/health/billing" },
  { slug: "bookkeeping",     group: "Admin",       status: "preview", title: "Bookkeeping",       blurb: "Patient records, financials, assessments",                       href: "/health/bookkeeping" },
]
...
export const INSTITUTE_MODULES: InstModuleDef[] = [
  { slug: "enrollment",    group: "Enrollment",  status: "live",    title: "Enrollment",       blurb: "Student registration, guardians, groups",          href: "/institute/enrollment" },
  { slug: "groups",        group: "Enrollment",  status: "live",    title: "Groups / Classes", blurb: "Class management, teacher assignment",              href: "/institute/groups" },
  { slug: "subjects",      group: "Academics",   status: "live",    title: "Subjects",         blurb: "Subject catalog, teacher mapping",                  href: "/institute/subjects" },
  { slug: "exams",         group: "Academics",   status: "live",    title: "Exams",            blurb: "Exam scheduling, grading, analytics",               href: "/institute/exams" },
  { slug: "gradebook",     group: "Academics",   status: "live",    title: "Gradebook",        blurb: "Grades overview, report cards",                     href: "/institute/gradebook" },
  { slug: "attendance",    group: "Academics",   status: "live",    title: "Attendance",        blurb: "Daily attendance, trends, alerts",                 href: "/institute/attendance" },
  { slug: "fees",          group: "Finance",     status: "live",    title: "Fees",             blurb: "Fee management, billing, outstanding",              href: "/institute/fees" },
  { slug: "payments",      group: "Finance",     status: "live",    title: "Payments",         blurb: "Payment ledger, receipts, reconciliation",          href: "/institute/payments" },
  { slug: "schedule",      group: "Operations",  status: "live",    title: "Timetable",        blurb: "Weekly schedule, room allocation",                  href: "/institute/schedule" },
  { slug: "calendar",      group: "Operations",  status: "live",    title: "Calendar",         blurb: "Academic calendar, events, holidays",               href: "/institute/calendar" },
  { slug: "communication", group: "Operations",  status: "live",    title: "Communication",    blurb: "Notices, SMS, circulars to parents",                href: "/institute/communication" },
  { slug: "staff",         group: "Admin",       status: "live",    title: "Staff",            blurb: "Staff directory, roles, assignments",               href: "/institute/staff" },
]
