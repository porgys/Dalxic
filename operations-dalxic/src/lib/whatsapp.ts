/**
 * WhatsApp Cloud API integration for DalxicOperations.
 *
...
export type MessageTemplate =
  | "sale_receipt"        // Sale completed, receipt sent
  | "low_stock_alert"    // Stock below minimum threshold
  | "fee_reminder"       // Fee payment reminder
  | "fee_received"       // Fee payment confirmed
  | "enrollment_confirm" // Member enrollment confirmed
  | "schedule_update";   // Timetable change notification
