...
/** Stricter config for AI/expensive endpoints */
export const AI_RATE_LIMIT: RateLimitConfig = { limit: 5, windowSeconds: 60 };

/**
 * Check rate limit for a given key.
 * Returns { allowed, remaining, resetIn } or a 429 Response if blocked.
 */
