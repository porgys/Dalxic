                    ...
                    <motion.div key={order.id} initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.04 }}
                      ...
                      <div style={{ display: "flex", gap: 16, alignItems: "center", marginBottom: 12 }}>
                        ...
                        <div>
                          ...
                          <p style={{ fontSize: 14, fontWeight: 700, fontFamily: "var(--font-jetbrains-mono), monospace", color: "#D4956B" }}>{order.dose}</p>
                        </div>
                        <div>
                          <p style={{ fontSize: 9, fontWeight: 700, color: "#64748B", textTransform: "uppercase", letterSpacing: "1.5px", marginBottom: 4 }}>Frequency</p>
                          <p style={{ fontSize: 12, color: "#94A3B8" }}>{order.frequency}</p>
                        </div>
                      </div>
